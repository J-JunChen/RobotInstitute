...
<div class="col-md-3 col-lg-3 textbox_list" id= "nav-list-id">
	...
	<div class="title_flex">
		<h2 class="post-03__title">学院风采</h2>
	...
	<section class="widget-text__widget widget-text__style-04 widget section_nav">
		...
		<div class="nav_item">
			 ...
			 <?php
 $institute_show_string = session('institute_show_session'); $institute_show_json = json_decode($institute_show_string,TRUE); foreach ($institute_show_json as $key => $value) { echo '
                    	 <a href="institute_show?title='.$value['catalog'].'&content='.$value['catalog_table'].'">
