...
<div class="col-md-3 col-lg-3 textbox_list" id= "nav-list-id">
	...
	<div class="title_flex">
		<h2 class="post-03__title">学院招生</h2>
	...
	<section class="widget-text__widget widget-text__style-04 widget section_nav">
		...
		<div class="nav_item">
			 ...
			 <?php
 $enroll_student_string = session('enroll_student_session'); $enroll_student_json = json_decode($enroll_student_string,TRUE); foreach ($enroll_student_json as $key => $value) { echo '
                    	 <a href="enroll_student?title='.$value['catalog'].'&content='.$value['catalog_table'].'">
...
'; } else{ echo '<div class="col-md-8 col-lg-8 textbox_list" >'; echo '<div class="title_flex">
				...
				<a href="'.$value['editable_table'].'?title='.$value['catalog'].'&content='.$value['catalog_table'].'&id='.$value['id'].'">
					<div>
						<h2 id="title" class="post-01__title">'.$value['title'].'</h2>
						<div class="aaa">
