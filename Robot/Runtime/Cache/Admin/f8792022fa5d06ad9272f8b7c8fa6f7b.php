  ...
  <div class="modal-dialog modal-lg" role="document">
   ...
   <div id="fh5co-main">
        ...
        <div id="fh5co-board" data-columns>
            ...
            <?php  use Think\Model; $table = M(session('catalog_table')); $data = $table->order('id desc')->select(); foreach ($data as $key => $value) { echo ' <div class="item" style = "box-shadow: 3px 3px 5px #888888;">
                ...
                <div class = "album_check" >
                    ...
                    <input type="checkbox" name="album_check"  value="'.$value['id'].'"/>
                     <div>
                        <p>上传时间：'.date('Y/m/d',$value['date']).'</p>
                        <p>上传者：'.$value['user_name'].'</p>
                        <span>用户类型：'.$value['user_type'].'</span>
                    </div>
                </div>
    ...
    <script src="/RobotInstitute/Public/js/Admin/working_album.js"></script>
