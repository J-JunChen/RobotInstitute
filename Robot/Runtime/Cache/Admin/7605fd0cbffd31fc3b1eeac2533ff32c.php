      ...
      <div class="custom-select">
        <select id="editable_title">
          <option value=''  disabled selected style='display:none;'>请选择栏目</option>  
            ...
            <?php
 $json_string = session('editable_session'); $editable_json = json_decode($json_string,TRUE); foreach ($editable_json as $key =>$value) { echo '<option value="'.$value['editable_table'].'">'.$value['editable_title'].'</option>'; } ?>
        </select>
      </div>
