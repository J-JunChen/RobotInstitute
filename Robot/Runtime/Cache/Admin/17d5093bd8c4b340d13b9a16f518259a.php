...
<div class="text-right" style=" margin: 0 20px -60px 0" >
    ...
    <div id="fh5co-main">
        ...
        <div id="fh5co-board" data-columns>
            ...
            <?php  $table = M('Index'); $data = $table->order('id desc')->select(); foreach ($data as $key => $value) { echo ' <div class="item" style = "box-shadow: 3px 3px 5px #888888;">
    ...
    <script src="/RobotInstitute/Public/js/Admin/working_slides.js"></script>
