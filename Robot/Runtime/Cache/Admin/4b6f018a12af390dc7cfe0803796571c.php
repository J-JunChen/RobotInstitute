      ...
      <div class="tile mb-4">
        <div class="row">
          <div class="col-lg-12">
            ...
            <?php
 foreach ($catalog_table_whole as $key => $value) { echo "<h2 class='mb-5  id='containers' style = 'font-weight: bold; '>标题：".$value['title']."</h2>"; echo "<h4 class='mb-3  id='containers'>更新时间：".date('Y-m-d',$value['date'])."</h4>"; echo "<h4 class='mb-5 line-head' id='containers'>编辑：".$value['user_name']."</h4>"; echo " <div>".$value['content']."</div>"; } ?>
