     ...
     <main class="app-content">
      ...
      <div class="app-title" >
        ...
        <div style="width: 100%;">
         ...
         <h1><i class="fa fa-book">资源下载</i></h1>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
             ...
             <tr> <td><span id='read_file'><a href='#' data-toggle='modal' data-target='#readFileModal' data ='0'>文件名</a></span> </td><td>2018/04/02</td> <td>实验室管理员</td> <td>实验室管理员</td> <td><span id='modify_file'><a href='#' data-toggle='modal' data-target='#modifyFileModal'data ='0'>修改</a></span> | <span id='delete_file'><a href='javascript:void(0)' style='color:red;''>删除</a></span></td></tr>
